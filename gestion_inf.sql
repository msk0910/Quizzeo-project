...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 05 fév. 2025 à 20:39
...
INSERT INTO `users` (`id_user`, `username`, `last_name`, `first_name`, `user_role`, `email`, `password`, `status`) VALUES
(1, 'Cedrenho', 'gueule', 'dAnge', 'Ecole', 'cedren@gmail.com', 'goodman', 1),
(2, 'Golden', 'cedrenho', 'rodriguez', 'stagiaire', 'ced@gmail.com', 'cedrogold', 1),
(3, 'Mac', 'Mac', 'Holden\'s', 'chef', 'macholde@gmail.com', 'macman', 1),
(4, 'pac', 'pacman', 'john', 'stagiaire', 'man@gmail.com', 'manpac', 0),
(5, 'blazz', 'saitama', 'king', 'Ecole', 'sa@g.com', 'sait', 0);
